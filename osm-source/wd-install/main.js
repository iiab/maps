...
map.on("click", function(evt) {
   ...
   document.getElementById("long").value = lon.toFixed(4);
...
$( document ).ready(function() {
    console.log( "ready!" );
    document.getElementById('instruct').innerHTML = "Submit the Form with valid inputs and copy the generated command into the terminal to install the Overlays."
